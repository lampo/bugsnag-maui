...
namespace Bugsnag.Maui.Payload
{
    ...
    public class Exceptions : IEnumerable<Exception>
    {
        ...
        private static IEnumerable<System.Exception> FlattenAndReverseExceptionTree(
            System.Exception ex
        )
        {
            if (ex == null)
    ...
    public class Exception : Dictionary<string, object>
    {
        ...
        public IEnumerable<StackTraceLine> StackTrace
        {
            get { return this.Get("stacktrace") as IEnumerable<StackTraceLine>; }
        }

        public string ErrorClass
        {
            get { return this.Get("errorClass") as string; }
        }

        public string ErrorMessage
        {
            get { return this.Get("message") as string; }
        }
