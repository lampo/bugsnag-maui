...
void bugsnag_startBugsnagWithConfiguration(BugsnagConfiguration *configuration, const char *notifierVersion) {
    if (notifierVersion) {
        configuration.notifier = [[BugsnagNotifier alloc] initWithName:@"Maui Bugsnag Notifier"
